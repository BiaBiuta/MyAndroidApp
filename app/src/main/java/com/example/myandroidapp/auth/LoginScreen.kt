        ...
        Column(
            ...
            TextField(
                ...
                keyboardOptions = KeyboardOptions.Default.copy(
                    keyboardType = KeyboardType.Email  // Setează tastatura pentru email
                ),
            ...
            if (loginUiState.isAuthenticatingProgress) {
...
//a side-effect handler -it it used when we change when dome dependence were changed
    LaunchedEffect(loginUiState.isAuthenticate) {
        //when authenticationComplete is changed
        Log.d(TAG, "Auth completed");
        if (loginUiState.isAuthenticate) {
            onClose();
        }
    }
}
